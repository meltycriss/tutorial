...
void protobuf_AssignDesc_scene_2eproto() {
  ...
  static const int GDir_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(GDir, gdir_),
  };
  GDir_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      GDir_descriptor_,
...
void protobuf_AddDesc_scene_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    ".scene.Point\"\"\n\004GDir\022\032\n\004gDir\030\001 \002(\0132\014.sce"
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int GDir::kGDirFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
void GDir::InitAsDefaultInstance() {
  gdir_ = const_cast< ::scene::Point*>(&::scene::Point::default_instance());
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:scene.GDir)
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_gdir()) {
      mutable_gdir()->::scene::Point::MergeFrom(from.gdir());
    }
  }
  if (from._internal_metadata_.have_unknown_fields()) {
    mutable_unknown_fields()->MergeFrom(from.unknown_fields());
...
// required .scene.Point gDir = 1;
bool GDir::has_gdir() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
void GDir::set_has_gdir() {
  _has_bits_[0] |= 0x00000001u;
}
void GDir::clear_has_gdir() {
  _has_bits_[0] &= ~0x00000001u;
}
void GDir::clear_gdir() {
  if (gdir_ != NULL) gdir_->::scene::Point::Clear();
  clear_has_gdir();
}
const ::scene::Point& GDir::gdir() const {
  // @@protoc_insertion_point(field_get:scene.GDir.gDir)
  return gdir_ != NULL ? *gdir_ : *default_instance_->gdir_;
}
::scene::Point* GDir::mutable_gdir() {
  set_has_gdir();
  if (gdir_ == NULL) {
...
void GDir::set_allocated_gdir(::scene::Point* gdir) {
  delete gdir_;
  gdir_ = gdir;
  if (gdir) {
    set_has_gdir();
