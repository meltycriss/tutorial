...
class Scene : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:scene.Scene) */ {
 public:
  Scene();
  virtual ~Scene();
  ...
  bool has_uavs() const;
  void clear_uavs();
  static const int kUavsFieldNumber = 1;
  const ::scene::Uavs& uavs() const;
  ::scene::Uavs* mutable_uavs();
  ::scene::Uavs* release_uavs();
  void set_allocated_uavs(::scene::Uavs* uavs);

  // required .scene.DynamicObstacles dos = 2;
  bool has_dos() const;
  void clear_dos();
  static const int kDosFieldNumber = 2;
  const ::scene::DynamicObstacles& dos() const;
  ::scene::DynamicObstacles* mutable_dos();
  ::scene::DynamicObstacles* release_dos();
  void set_allocated_dos(::scene::DynamicObstacles* dos);

  // required .scene.StaticObstacles sos = 3;
  bool has_sos() const;
  void clear_sos();
  static const int kSosFieldNumber = 3;
  const ::scene::StaticObstacles& sos() const;
  ::scene::StaticObstacles* mutable_sos();
  ::scene::StaticObstacles* release_sos();
  void set_allocated_sos(::scene::StaticObstacles* sos);

  // required .scene.UavsDir uavsDir = 4;
  bool has_uavsdir() const;
  void clear_uavsdir();
  static const int kUavsDirFieldNumber = 4;
  const ::scene::UavsDir& uavsdir() const;
  ::scene::UavsDir* mutable_uavsdir();
  ::scene::UavsDir* release_uavsdir();
  void set_allocated_uavsdir(::scene::UavsDir* uavsdir);

  // required .scene.GDir gDir = 5;
  bool has_gdir() const;
  void clear_gdir();
  static const int kGDirFieldNumber = 5;
  const ::scene::GDir& gdir() const;
  ::scene::GDir* mutable_gdir();
  ::scene::GDir* release_gdir();
  void set_allocated_gdir(::scene::GDir* gdir);

  // required .scene.A a = 6;
  bool has_a() const;
  void clear_a();
  static const int kAFieldNumber = 6;
  const ::scene::A& a() const;
  ::scene::A* mutable_a();
  ::scene::A* release_a();
  void set_allocated_a(::scene::A* a);

  // required .scene.B b = 7;
  bool has_b() const;
  void clear_b();
  static const int kBFieldNumber = 7;
  const ::scene::B& b() const;
  ::scene::B* mutable_b();
  ::scene::B* release_b();
  void set_allocated_b(::scene::B* b);

  // @@protoc_insertion_point(class_scope:scene.Scene)
 private:
  inline void set_has_uavs();
  inline void clear_has_uavs();
  inline void set_has_dos();
  inline void clear_has_dos();
  inline void set_has_sos();
  inline void clear_has_sos();
  inline void set_has_uavsdir();
  inline void clear_has_uavsdir();
  ...
  mutable int _cached_size_;
  ::scene::Uavs* uavs_;
  ::scene::DynamicObstacles* dos_;
  ::scene::StaticObstacles* sos_;
  ::scene::UavsDir* uavsdir_;
  ::scene::GDir* gdir_;
  ::scene::A* a_;
  ::scene::B* b_;
  friend void  protobuf_AddDesc_scene_2eproto();
...
// required double x = 1;
inline bool GDir::has_x() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void GDir::set_has_x() {
  _has_bits_[0] |= 0x00000001u;
}
inline void GDir::clear_has_x() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void GDir::clear_x() {
  x_ = 0;
  clear_has_x();
}
inline double GDir::x() const {
  // @@protoc_insertion_point(field_get:scene.GDir.x)
  return x_;
}
inline void GDir::set_x(double value) {
  set_has_x();
  x_ = value;
...
// required double y = 2;
inline bool GDir::has_y() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void GDir::set_has_y() {
  _has_bits_[0] |= 0x00000002u;
}
inline void GDir::clear_has_y() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void GDir::clear_y() {
  y_ = 0;
  clear_has_y();
}
inline double GDir::y() const {
  // @@protoc_insertion_point(field_get:scene.GDir.y)
  return y_;
}
inline void GDir::set_y(double value) {
  set_has_y();
  y_ = value;
...
// required .scene.Uavs uavs = 1;
inline bool Scene::has_uavs() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void Scene::set_has_uavs() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Scene::clear_has_uavs() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Scene::clear_uavs() {
  if (uavs_ != NULL) uavs_->::scene::Uavs::Clear();
  clear_has_uavs();
}
inline const ::scene::Uavs& Scene::uavs() const {
  // @@protoc_insertion_point(field_get:scene.Scene.uavs)
  return uavs_ != NULL ? *uavs_ : *default_instance_->uavs_;
}
inline ::scene::Uavs* Scene::mutable_uavs() {
  set_has_uavs();
  if (uavs_ == NULL) {
...
inline ::scene::Uavs* Scene::release_uavs() {
...
inline void Scene::set_allocated_uavs(::scene::Uavs* uavs) {
  delete uavs_;
  uavs_ = uavs;
  if (uavs) {
    set_has_uavs();
...
// required .scene.DynamicObstacles dos = 2;
inline bool Scene::has_dos() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void Scene::set_has_dos() {
  _has_bits_[0] |= 0x00000002u;
}
inline void Scene::clear_has_dos() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void Scene::clear_dos() {
  if (dos_ != NULL) dos_->::scene::DynamicObstacles::Clear();
  clear_has_dos();
}
inline const ::scene::DynamicObstacles& Scene::dos() const {
  // @@protoc_insertion_point(field_get:scene.Scene.dos)
  return dos_ != NULL ? *dos_ : *default_instance_->dos_;
}
inline ::scene::DynamicObstacles* Scene::mutable_dos() {
  set_has_dos();
  if (dos_ == NULL) {
...
inline ::scene::DynamicObstacles* Scene::release_dos() {
...
inline void Scene::set_allocated_dos(::scene::DynamicObstacles* dos) {
  delete dos_;
  dos_ = dos;
  if (dos) {
    set_has_dos();
...
// required .scene.StaticObstacles sos = 3;
inline bool Scene::has_sos() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void Scene::set_has_sos() {
  _has_bits_[0] |= 0x00000004u;
}
inline void Scene::clear_has_sos() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void Scene::clear_sos() {
  if (sos_ != NULL) sos_->::scene::StaticObstacles::Clear();
  clear_has_sos();
}
inline const ::scene::StaticObstacles& Scene::sos() const {
  // @@protoc_insertion_point(field_get:scene.Scene.sos)
  return sos_ != NULL ? *sos_ : *default_instance_->sos_;
}
inline ::scene::StaticObstacles* Scene::mutable_sos() {
  set_has_sos();
  if (sos_ == NULL) {
...
inline ::scene::StaticObstacles* Scene::release_sos() {
...
inline void Scene::set_allocated_sos(::scene::StaticObstacles* sos) {
  delete sos_;
  sos_ = sos;
  if (sos) {
    set_has_sos();
...
// required .scene.UavsDir uavsDir = 4;
inline bool Scene::has_uavsdir() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void Scene::set_has_uavsdir() {
  _has_bits_[0] |= 0x00000008u;
}
inline void Scene::clear_has_uavsdir() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void Scene::clear_uavsdir() {
  if (uavsdir_ != NULL) uavsdir_->::scene::UavsDir::Clear();
  clear_has_uavsdir();
}
inline const ::scene::UavsDir& Scene::uavsdir() const {
  // @@protoc_insertion_point(field_get:scene.Scene.uavsDir)
  return uavsdir_ != NULL ? *uavsdir_ : *default_instance_->uavsdir_;
}
inline ::scene::UavsDir* Scene::mutable_uavsdir() {
  set_has_uavsdir();
  if (uavsdir_ == NULL) {
...
inline ::scene::UavsDir* Scene::release_uavsdir() {
...
inline void Scene::set_allocated_uavsdir(::scene::UavsDir* uavsdir) {
  delete uavsdir_;
  uavsdir_ = uavsdir;
  if (uavsdir) {
    set_has_uavsdir();
...
// required .scene.GDir gDir = 5;
inline bool Scene::has_gdir() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void Scene::set_has_gdir() {
  _has_bits_[0] |= 0x00000010u;
}
inline void Scene::clear_has_gdir() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void Scene::clear_gdir() {
  if (gdir_ != NULL) gdir_->::scene::GDir::Clear();
  clear_has_gdir();
}
inline const ::scene::GDir& Scene::gdir() const {
  // @@protoc_insertion_point(field_get:scene.Scene.gDir)
  return gdir_ != NULL ? *gdir_ : *default_instance_->gdir_;
}
inline ::scene::GDir* Scene::mutable_gdir() {
  set_has_gdir();
  if (gdir_ == NULL) {
...
inline ::scene::GDir* Scene::release_gdir() {
...
inline void Scene::set_allocated_gdir(::scene::GDir* gdir) {
  delete gdir_;
  gdir_ = gdir;
  if (gdir) {
    set_has_gdir();
...
// required .scene.A a = 6;
inline bool Scene::has_a() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void Scene::set_has_a() {
  _has_bits_[0] |= 0x00000020u;
}
inline void Scene::clear_has_a() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void Scene::clear_a() {
  if (a_ != NULL) a_->::scene::A::Clear();
  clear_has_a();
}
inline const ::scene::A& Scene::a() const {
  // @@protoc_insertion_point(field_get:scene.Scene.a)
  return a_ != NULL ? *a_ : *default_instance_->a_;
}
inline ::scene::A* Scene::mutable_a() {
  set_has_a();
  if (a_ == NULL) {
    a_ = new ::scene::A;
  }
...
inline ::scene::A* Scene::release_a() {
...
inline void Scene::set_allocated_a(::scene::A* a) {
  delete a_;
  a_ = a;
  if (a) {
    set_has_a();
...
// required .scene.B b = 7;
inline bool Scene::has_b() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void Scene::set_has_b() {
  _has_bits_[0] |= 0x00000040u;
}
inline void Scene::clear_has_b() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void Scene::clear_b() {
  if (b_ != NULL) b_->::scene::B::Clear();
  clear_has_b();
}
inline const ::scene::B& Scene::b() const {
  // @@protoc_insertion_point(field_get:scene.Scene.b)
  return b_ != NULL ? *b_ : *default_instance_->b_;
}
inline ::scene::B* Scene::mutable_b() {
  set_has_b();
  if (b_ == NULL) {
    b_ = new ::scene::B;
  }
...
inline ::scene::B* Scene::release_b() {
...
inline void Scene::set_allocated_b(::scene::B* b) {
  delete b_;
  b_ = b;
  if (b) {
    set_has_b();
